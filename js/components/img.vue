<template>
    <table cellpadding="0" cellspacing="0" border="0"
            style="border-collapse:collapse;border:0;position: relative;border-spacing: 0;padding:0;position:relative;z-index: 20"
            v-bind:style="ccsWidth,cssMaxWidth">
        <tr>
            <td style="padding:0;">
                <!--<label for="inputFile" ref="label" style="margin:0;padding:0">-->
                    <a  @click.prevent="trigger" style="z-index:2;position:relative;text-decoration:none;outline: none;cursor: pointer !important;" @mouseover="imgHover" @mouseout="imgHoverOut">
                        <img :src="img.changed !== null ? img.changed : img.default" :alt="img.default" v-bind:style="ccsWidth,cssMaxWidth" v-bind:width="imgwidth">
    ...
    export default{
        ...
        methods:{
            ...
            createImage(file,event) {
                ...
                reader.onload = (e) => {
                    vm.$set(vm.img,'changed', e.target.result)
                // vm.img.changed = e.target.result;
                };
